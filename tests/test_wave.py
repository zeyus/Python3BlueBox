...
class TestWave(unittest.TestCase):
    ...
    def test_sine(self) -> None:
        ...
        for i in range(1, 10):
            self.assertAlmostEqual(sine_wave[i], math.sin(2 * math.pi * 5 * i / 10))
